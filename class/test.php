<?php
    ...
    ->SetSup(1000)->SetEmbauche("2020-10-27")->SetSalaire(50000)->SetServ(1);

    $employe2 = new Employe();
    $employe2->setNoemp(5558)->setNom("Pots")->setPrenom("Pepper")->SetPoste("Assistante")
    ...
    ->SetSup(5557)->SetEmbauche("2020-10-27")->SetSalaire(30000)->SetServ(3);

    $employe4 = new Employe();
    $employe4->setNoemp(6000)->setNom("Grey")->setPrenom("Jean")->SetPoste("Scientifique")
    ->SetSup(5557)->SetEmbauche("2020-10-27")->SetSalaire(30000)->SetServ(4);
